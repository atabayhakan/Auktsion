...
export const mockAdminListings: AdminListing[] = [
  {
    id: 'lot-101',
    title: 'Аргымак (Англис таза кандуу тукуму, 3 жашар)',
    description: 'Эл аралык көк бөрү жана чабыш үчүн ылайыктуу. Ветпаспорту толук, бардык эмдөөлөрү жасалган. Документтери бар.',
    category: 'livestock',
    subCategory: 'horses',
    images: [
    ...
    reservePrice: formatMoney(300000),
    buyNowPrice: formatMoney(450000),
    bidIncrement: formatMoney(5000),
    bidCount: 14,
    status: 'active',
    sellerId: 'user-002',
    seller: {
    ...
    endsAt: new Date(Date.now() + 1000 * 60 * 45).toISOString(), // 45m left
  ...
  {
    id: 'lot-102',
    title: 'Гиссар породасындагы 10 баш эт багытындагы кочкор',
    description: 'Чүй өрөөнүнөн асыл тукум гиссар кочкорлор. Салмактары 110-130 кг. Асыл тукум күбөлүгү берилет.',
    category: 'livestock',
    subCategory: 'sheep',
    images: [
      'https://images.unsplash.com/photo-1484557052118-f32bd25b45b5?auto=format&fit=crop&w=800&q=80'
    ],
    startingPrice: formatMoney(400000),
    currentPrice: formatMoney(480000),
    reservePrice: formatMoney(450000),
    bidIncrement: formatMoney(10000),
    bidCount: 8,
    status: 'active',
    sellerId: 'user-002',
    seller: {
    ...
    city: 'Чүй / Ысык-Ата',
    startAt: '2026-08-15T12:00:00Z',
    endsAt: new Date(Date.now() + 1000 * 60 * 180).toISOString(),
  ...
  },
  {
    ...
    description: 'Оригинал GR-Sport комплектация, басып өткөн аралыгы 18,000 км. Бишкек шаарында бажы төлөмү 100% төлөнгөн.',
    category: 'vehicles',
    subCategory: 'suv',
    images: [
    ...
    reservePrice: formatMoney(9000000),
    buyNowPrice: formatMoney(9800000),
    bidIncrement: formatMoney(50000),
    bidCount: 16,
    status: 'active',
    sellerId: 'user-005',
    seller: {
    ...
    endsAt: new Date(Date.now() + 1000 * 60 * 12).toISOString(), // 12m left
  ...
  {
    id: 'lot-104',
    title: 'Дордой Базары: 2 кабаттуу 40 футтук соода контейнери',
    description: 'Европа өтмөгүндөгү кызыл китеби бар коммерциялык контейнер. Айлык кирешеси 80,000 сом.',
    category: 'real_estate',
    subCategory: 'commercial',
    images: [
      'https://images.unsplash.com/photo-1582407947304-fd86f028f716?auto=format&fit=crop&w=800&q=80'
    ],
    startingPrice: formatMoney(2800000),
    currentPrice: formatMoney(2800000),
    reservePrice: formatMoney(3200000),
    bidIncrement: formatMoney(50000),
    bidCount: 0,
  ...
  {
    id: 'lot-105',
    title: 'Швейцариялык кол сааты Rolex Submariner (Original, Box & Papers)',
    description: '2022-жылкы нукура саат. Бардык документтери, эл аралык гарантия картасы менен.',
    category: 'jewelry',
    subCategory: 'watches',
    images: [
    ...
    reservePrice: formatMoney(1200000),
    bidIncrement: formatMoney(25000),
    bidCount: 6,
    status: 'flagged', // Reported as potential replica
    sellerId: 'user-004',
    seller: {
      id: 'user-004',
      fullName: 'Канат Эркинов',
